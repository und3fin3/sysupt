...
global $maxsubsize_main, $uploadsub_class, $beanonymous_class, $uploadsubtitle_bonus, $delownsub_class, $submanage_class, $BASEURL, $viewanonymous_class;
