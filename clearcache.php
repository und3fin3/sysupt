...
?>
    <form method=post action=clearcache.php>
        <table border=1 cellspacing=0 cellpadding=5>
            <tr>
                <td class=rowhead>Cache name</td>
                <td><input type=text name=cachename size=40></td>
            </tr>
            <tr>
                <td class=rowhead>Multi languages</td>
                <td><input type=checkbox name=multilang>Yes</td>
            </tr>
            <tr>
