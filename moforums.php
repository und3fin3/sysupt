...
if ($act == "del") {
    ...
    if (!$id) {
        header("Location: {$_SERVER['PHP_SELF']}?action=forum");
        die();
    }
...
// SHOW FORUMS WITH FORUM MANAGMENT TOOLS
    ...
    if ($row = mysql_fetch_array($result)) {
        do {
            ...
            echo "<td>" . get_user_class_name($row["minclassview"], false, true, true) . "</td><td><b><a href=\"" . $_SERVER['PHP_SELF'] . "?action=editforum&id=" . $row["id"] . "\">" . $lang_moforums['text_edit'] . "</a>&nbsp;|&nbsp;<a href=\"javascript:confirm_delete('" . $row["id"] . "', '" . $lang_moforums['js_sure_to_delete_overforum'] . "', '');\"><font color=red>" . $lang_moforums['text_delete'] . "</font></a></b></td></tr>";
