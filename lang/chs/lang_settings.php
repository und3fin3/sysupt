...
$lang_settings = array(
    ...
    'text_delete_inactive_accounts' => "禁用不活跃账号",
    'text_never_delete' => "及以上等级的账号将永远保留。默认",
    'row_never_delete_if_packed' => "封存后永远保留",
    'text_never_delete_if_packed' => "及以上等级的账号如果在封存后将永远保留。默认",
    'row_delete_packed' => "禁用封存账号",
    'text_delete_packed_note_one' => "封存的账号如果连续",
    'text_delete_packed_note_two' => "天不登录，将被禁用。默认'400'，设为'0'来禁止此规则。",
    'row_delete_unpacked' => "禁用未封存账号",
    'text_delete_unpacked_note_one' => "未封存的账号如果连续",
    'text_delete_unpacked_note_two' => "天不登录，将被禁用。默认'150'，设为'0'来禁止此规则。",
    'row_delete_no_transfer' => "禁用没有流量的用户",
    'text_delete_transfer_note_one' => "没有流量的用户（即上传/下载数据都为0）如果连续",
    'text_delete_transfer_note_two' => "天不登录，或者注册时间满",
    'text_delete_transfer_note_three' => "天，将被禁用账号。默认'60'，'0'。<br />注意：两条规则是分开执行的。将其中任一规则设为‘0’<b>只</b>禁止一条规则。",
    ...
    'row_enable_public_ipv4' => "允许公网IPv4访问",
    'text_enable_public_ipv4' => "默认'是'。关闭公网IPv4访问将禁止所有非TJUIP访问，但Tracker不会受到影响。",
    ...
    'text_attachment_authority_note_two' => "<b>注意：</b><ul><li><b>不要</b>改变用户等级、文件数限制、文件大小限制递增的排序。</li><li>将文件大小限制设为'0'，文件数限制设为'0'，允许的文件扩展名设为''（即留空）才能<b>禁止</b>相应规则。</li><li>高等级的用户自动继承低等级用户的权限，所以<b>没</b>必要在多条规则中填写相同的允许文件扩展名。</li><li>多个允许的文件扩展名用半角逗号','分隔。</li><li>无论如何设置，<b>没有</b>任何人能上传文件大小超过10 MB或扩展名为'com, bat, msi'之一的附件。</li></ul>",
    ...
    'row_site_logo_url' => "网站logo超链接",
    'text_site_logo_url_note' => "网站logo超链接，用来跳转到活动/主题等论坛帖子",
    ...
    'text_separate' => "Separate（tracker按序分布于多个tier中）",
