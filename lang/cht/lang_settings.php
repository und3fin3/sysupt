...
(
	...
	'text_attachment_authority_note_two' => "<b>注意：</b><ul><li><b>不要</b>改變用戶等級、檔案數限制、檔案大小限制遞增的排序。</li><li>將檔案大小限制設為'0'，檔案數限制設為'0'，允許的檔案副檔名設為''（即留空）才能<b>禁止</b>相應規則。</li><li>高等級的用戶自動繼承低等級用戶的許可權，所以<b>沒</b>必要在多條規則中填寫相同的允許檔案副檔名。</li><li>多個允許的檔案副檔名用半角逗點','分隔。</li><li>無論如何設定，<b>沒有</b>任何人能上傳檔案大小超過10 MB或副檔名為'com, bat, msi'之一的屬裝置。</li></ul>",
