...
<table width="100%">
    ...
    <tr>
        <td class="text" valign="top">
            <div style="margin-left: 16pt;">1.banned:含有此类文件的种子将无法发布并且不会转为候选。<br/>2.notallowed:含有此类文件的种子将无法发布而会转为候选。<br/>3.默认banned:(qsv)|(KUX);<br/>默认notallowed:(torrent)|(!ut)|(url)|(qdl2)|(td)|(tdl)|(td\.cfg)|(tmp)。<br/>
            </div>
        </td>
    </tr>
    </tbody>
