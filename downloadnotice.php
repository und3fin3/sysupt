                    ...
                    <table width="100%">
                        <tr>
                            <td class="embedded" style="text-align: center; padding: 5px;" width="50%">
                                <a href="forums.php?action=viewtopic&forumid=15&topicid=15039" target="_blank"
...
<a href="http://azureus.sourceforge.net/download.php" target="_blank" title="<?php echo $lang_downloadnotice['title_download']?>Vuze"><img src="pic/vuzebig.png" alt="Vuze" /></a>
                        ...
                        <tr>
                            <td class="embedded" style="text-align: center; padding: 5px;">
                                <div class="big"><a href="forums.php?action=viewtopic&forumid=15&topicid=15039"
                                                    target="_blank"
                                                    title="<?php echo $lang_downloadnotice['title_download'] ?>uTorrent"><b>uTorrent</b></a>
                                </div>
                ...
                <td class="text" colspan="2">
                    <form action="?" method="post">
                        <p><?php echo $lang_downloadnotice['text_for_more_information_read'] ?><a class="faqlink"
                            ...
                            if ($type != 'firsttime' || get_user_class() > 0) {
                                ...
                                <input type="checkbox" name="hidenotice" id="hidenotice"
                                       value="1"<?php echo $forcecheck ? " disabled=\"disabled\"" : " checked=\"checked\"" ?> />
                        ...
                        <div><input type="submit" name="submit" id="continuedownload"
                                    ...
                                    value="<?php echo $lang_downloadnotice['submit_download_the_torrent'] ?>"<?php echo $forcecheckratio ? " disabled=\"disabled\"" : "" ?> />
                        </div>
                    </form>
                </td>
            </tr>
