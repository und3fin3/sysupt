...
if (mysql_num_rows($offerres) > 0) {
        ...
        <table border="1" cellspacing="0" cellpadding="5" width="940">
            <tr>
                <td class='colhead' colspan='2' align='center'>
                    <?php echo $lang_upload['text_tracker_url'] ?>:
                    &nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo get_protocol_prefix() . $announce_urls[0] ?></b>
                    <?php
    ...
    <form id="compose" enctype="multipart/form-data" action="takeupload.php" method="post" name="upload"
          onsubmit="return validate('browsecat')">
        <table border="1" cellspacing="0" cellpadding="5" width="940">
            <tr>
                <td class='colhead' colspan='2' align='center'>
                    <?php echo $lang_upload['text_tracker_url'] ?>:
            ...
            <?php
            tr($lang_upload['row_torrent_file'] . "<font color=\"red\">*</font>", "<input type=\"file\" class=\"file\" id=\"torrent\" name=\"file\" onchange=\"get_torrent_name()\" accept='application/x-bittorrent' style='width: 300px'/><span id='torrent_name' style='margin-left: 20px; color: red;'></span>\n", 1);
...
<b>".$lang_upload['text_chinese_title']."</b>&nbsp;<input type=\"text\" style=\"width: 250px\" name=\"cnname\"><br /><font class=\"medium\">".$lang_upload['text_titles_note']."</font>", 1);
            ...
            */
            ...
            if (get_user_class() >= UC_UPLOADER) {
                tr($lang_upload['row_feature'], "<input type = \"checkbox\" name = \"exclusive\" value = \"yes\" />" . $lang_upload ['checkbox_exclusive'] . "&nbsp;&nbsp;&nbsp;" . "<input type = \"checkbox\" name = \"sysuptrip\" value = \"yes\" />" . $lang_upload ['checkbox_sysuptrip'], 1);
            }
            ?>
            <tr>
                <td class="toolbox" align="center" colspan="2"><b><?php echo $lang_upload['text_read_rules'] ?></b>
                    <input id="qr" type="submit" class="btn" value="<?php echo $lang_upload['submit_upload'] ?>"/></td>
            </tr>
        </table>
    </form>
