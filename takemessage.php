...
loggedinorreturn();
global $CURUSER, $staffmem_class, $emailnotify_smtp, $smtptype, $SITENAME, $SITEEMAIL, $BASEURL;
...
stdhead();
stdmsg($lang_takemessage['std_succeeded'], ($lang_takemessage['std_message_was']) . $lang_takemessage['std_successfully_sent']);
stdfoot();