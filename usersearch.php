    ...
    <form method=get action=<?php echo $_SERVER["PHP_SELF"] ?>>
        <table border="1" cellspacing="0" cellpadding="5">
            <tr>
                ...
                <td<?php echo $_GET['n'] ? $highlight : "" ?>><input name="n" type="text"
            ...
            <tr>
                ...
                <td<?php echo $_GET['ip'] ? $highlight : "" ?>><input name="ip" type="text"
                                                                      value="<?php echo $_GET['ip'] ?>" maxlength="17">
                </td>
            ...
            <tr>
                ...
                <td<?php echo $_GET['ma'] ? $highlight : "" ?>><input name="ma" type="text"
                                                                      value="<?php echo $_GET['ma'] ?>" maxlength="17">
                </td>
            ...
            <tr>
                ...
                <td<?php echo $_GET['ul'] ? $highlight : "" ?>><select name="ult" id="ult">
                    ...
                    <input name="ul2" type="text" id="ul2" size="8" maxlength="7" value="<?php echo $_GET['ul2'] ?>">
                </td>
            ...
            <tr>
                ...
                <td<?php echo $_GET['dl'] ? $highlight : "" ?>><select name="dlt" id="dlt">
                    ...
                    <input name="dl2" type="text" id="dl2" size="8" maxlength="7" value="<?php echo $_GET['dl2'] ?>">
                </td>
