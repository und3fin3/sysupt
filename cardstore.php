...
if (!$action) {
    ...
    <table width="100%">
        <tr>
            <td class="colhead" colspan="5" align="center"><font class="big">道具卡商城</font></td>
        </tr>
        <?php
        if ($msg)
        ...
        <tr>
            <td class="text" align="center" colspan="5">
                <b>用你的魔力值来购买神奇的道具卡！道具卡购买后需使用才能生效！道具卡可以转让，也可以出售，出售价格为购入价格的60%。</b></td>
        </tr>
        <tr>
            <td class="colhead" align="center">项目</td>
            <td class="colhead" align="left">简介</td>
            <td class="colhead" width="200px" align="center">价格</td>
            <td class="colhead" align="center">类别</td>
            <td class="colhead" align="center">交换</td>
        </tr>
        <tr>
            <form action="?action=exchange" method="post">
                <td class="rowhead_center"><input type="hidden" name="type" value="free"><b>1</b></td>
                <td class="rowfollow" align="left"><h1>优惠卡</h1>这种卡片能使一个种子在24小时变为你想要的优惠种类！免费有以下几种：<br><span
                            style="color: #7c7ff6;"><b>50%下载</b></span> <span style="color: #f0cc00;"><b>免费</b></span>
                    <span style="color: #aaaaaa;"><b>2x上传</b></span> <span style="color: #7ad6ea;"><b>50%下载&amp;2x上传</b></span>
                    <span style="color: #99cc66;"><b>免费&amp;2x上传</b></span><br>价格与优惠种类以及种子体积有关。<font color=red>只有当前没有任何优惠的种子才能使用优惠卡哦！</font>
                </td>
                <td class="rowfollow" align="center"><span style="color: #7c7ff6;"><b>50%下载</b></span>——500/GB<br><span
                            style="color: #f0cc00;"><b>免费</b></span>——1000/GB<br><span
                            style="color: #aaaaaa;"><b>2x上传</b></span>——1000/GB<br><span style="color: #7ad6ea;"><b>50%下载&amp;2x上传</b></span>——1500/GB<br><span
                            style="color: #99cc66;"><b>免费&amp;2x上传</b></span>——2000/GB
                </td>
                ...
                <td><input type="submit" name="buy" value="交换"></td>
            </form>
        </tr>
        <tr>
            <form action="?action=exchange" method="post">
                <td class="rowhead_center"><input type="hidden" name="type" value="upload"><b>2</b></td>
                <td class="rowfollow" align="left"><h1>上传卡</h1>碰碰运气吧！这张卡可以让你获得随机数值的上传量！<br>随机范围：普通卡：1G-10G；高级卡：10G-100G
                </td>
                <td class="rowfollow" align="center">普通卡：2000<br>高级卡：20000</td>
                <td class="rowfollow" align="center"><select class="med" name="value" style="width: 100px;">
        ...
        <tr>
            <form action="?action=exchange" method="post">
                <td class="rowhead_center"><input type="hidden" name="type" value="download"><b>2</b></td>
                <td class="rowfollow" align="left"><h1>下载卡</h1>碰碰运气吧！这张卡可以让你获得随机数值的下载量！<br>随机范围：普通卡：1G-10G；高级卡：10G-100G
                </td>
                <td class="rowfollow" align="center">普通卡：10000<br>高级卡：100000</td>
                <td class="rowfollow" align="center"><select class="med" name="value" style="width: 100px;">
                        <option value="1">普通卡</option>
                        <option value="2">高级卡</option>
                    </select></td>
