...
loggedinorreturn();
parked();
global $CURUSER, $enableextforum, $forumpostsperpage, $forumtopicsperpage_main, $postmanage_class, $starttopic_bonus, $makepost_bonus, $Advertisement, $SITENAME, $enabletooltip_tweak, $showforumstats_main, $forummanage_class;
        ...
        case 'quote' :
            {
                ...
                $body = "[quote=" . htmlspecialchars($arr ["username"]) . "]" . htmlspecialchars($arr ["body"]) . "[/quote] @" . htmlspecialchars($arr ["username"]) . " ";
                $id = $topicid;
                $type = 'reply';
                break;
            }
...
if ($action == "viewtopic") {
    ...
    while ($arr = mysql_fetch_assoc($res)) {
        ...
        if ($maypost) {
            print ('<a onclick="quick_reply_to(\'' . $arr2 ["username"] . '\',\'' . ($pn + $offset) . '\');" href="#quickreply"><img class="f_reply" src="pic/trans.gif" alt="Reply" title="回复该用户"></a>');
