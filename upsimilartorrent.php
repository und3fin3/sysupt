...
global $CURUSER, $enablespecial, $movetorrent_class, $smalldescription_main, $enablenfo_main, $torrentsticky_class, $viewnfo_class, $beanonymous_class, $torrentmanage_class;
loggedinorreturn();
