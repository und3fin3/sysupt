...
if (get_user_class() < UC_MODERATOR)
    permissiondenied();
if ($_POST["question"]) {
    if (mysql_num_rows(sql_query("SELECT * FROM questions WHERE question = '" . mysql_real_escape_string($_POST["question"]) . "'"))) {
        print("<h1>该题已存在</h1>");
        die;
    }
    ...
    <table width="80%" border="1" cellspacing="0" cellpadding="10">
        <tr>
            <form action="<?php echo str_replace("/", "", $_SERVER['PHP_SELF']); ?>" method="post">
                <td class="text" align="right" width="7%">题目</td>
                <td class="text" align="left" width="93%"><input type="text" name="question" size="120"></td>
        </tr>
        <td class="text" align="right">A</td>
        <td class="text" align="left"><input type="text" name="question1"><input type="checkbox" name="answer[]"
                                                                                 value="1"></td>
        </tr>
        <td class="text" align="right">B</td>
        <td class="text" align="left"><input type="text" name="question2"><input type="checkbox" name="answer[]"
                                                                                 value="2"></td>
        </tr>
        <td class="text" align="right">C</td>
        <td class="text" align="left"><input type="text" name="question4"><input type="checkbox" name="answer[]"
                                                                                 value="4"></td>
        </tr>
        <td class="text" align="right">D</td>
        <td class="text" align="left"><input type="text" name="question8"><input type="checkbox" name="answer[]"
                                                                                 value="8"></td>
        </tr></table>
    <table width="80%" border="1" cellspacing="0" cellpadding="10">
        <tr align="center">
