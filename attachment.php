...
global $CURUSER, $savedirectorytype_attachment, $savedirectory_attachment, $thumbnailtype_attachment,
       $thumbheight_attachment, $thumbquality_attachment, $thumbwidth_attachment, $altthumbheight_attachment,
       $altthumbwidth_attachment, $watermarkpos_attachment, $watermarkheight_attachment, $watermarkwidth_attachment,
       $watermarkquality_attachment;
