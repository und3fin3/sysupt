                ...
                <table width=100% border=1 cellspacing=0 cellpadding=10>
                    <tr>
                        <td class=text>
                            ...
                            archives properly it's often best to use <a
                                    href="http://www.geocities.com/davidayton/CDisplay">
                                CDisplay</a>.<br/>
                            <br/>
                        </td>
                    </tr>
...
windowsmedia/default.aspx">Windows Media Player</a>. Also, you'll need to make sure you have
                            the right codecs to play each individual file. Codecs are a tricky business sometimes so to
                            help
...
gspot/download.html">GSpot</a>. It tells you what codecs you need. Then just look on the net to find
                            ...
                            There are however alternatives to the original program,
                            check out <a href="http://home.hccnet.nl/h.edskes/finalbuilds.htm">Real
                                Alternative</a>.<br/>
                            <br/>
                            <br/>
                            <b>vcd/svcd</b><br/>
                            ...
                            These guys know their stuff, and can help you with all kinds of media related
                            questions.<br/>
                            <br/>
                            <br/>
                            <b>.mp3 .mp2</b><br/>
                ...
                <table width=100% border=1 cellspacing=0 cellpadding=10>
                    <tr>
                        <td class=text>
                            ...
                            contained within any given image file you can use <a
                                    href="http://cdmage.cjb.net/">CDMage</a>
                ...
                <table width=100% border=1 cellspacing=0 cellpadding=10>
                    <tr>
                        <td class=text>
                            ...
                            with Notepad, Wordpad, <a href="http://www.damn.to/software/nfoviewer.html">DAMN NFO
                                Viewer</a>
                ...
                <table width=100% border=1 cellspacing=0 cellpadding=10>
                    <tr>
                        <td class=text>
                            ...
                            If you have any suggestion/changes <a href=staff.php><b>PM</b></a> one of the
                            Admins/SysOp!<br/>
                            <br/>
