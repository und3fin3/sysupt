...
global $CURUSER, $cruprfmanage_class, $prfmanage_class, $viewinvite_class, $where_tweak, $userprofile_class, $enablelocation_tweak, $torrenthistory_class, $viewhistory_class, $staffmem_class;
...
print("<h1 style='margin:0'>" . get_username($user['id'], true, false) . $country . "</h1>");
