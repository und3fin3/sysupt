...
$temporary_invite = $MAIN ['temporary_invite'];
$temporary_invite_checkip = $MAIN ['temporary_invite_checkip'];
$permanent_invite = $MAIN ['permanent_invite'];
$permanent_invite_checkip = $MAIN ['permanent_invite_checkip'];
$self_invite = $MAIN ['self_invite'];
$self_invite_checkip = $MAIN ['self_invite_checkip'];
$registration = $MAIN ['registration'];
$registration_checkip = $MAIN ['registration_checkip'];
