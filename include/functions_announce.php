...
function check_cheater($userid, $username, $torrentid, $uploaded, $downloaded, $anctime, $ip, $port, $seeders = 0, $leechers = 0)
{
    ...
    if ($uploaded > 1073741824 && $upspeed > 50 * 1024 * 1024) //Uploaded more than 1 GB with uploading rate higher than 50 MB/s (For Consertive level). This is likely cheating.
    {
